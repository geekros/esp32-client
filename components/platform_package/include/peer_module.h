...
// Include peer type module header
#include "peer_type_module.h"

// Define peer state types
typedef enum
{
...
// Define peer data channel types
typedef enum
{
...
// Define peer media direction types
typedef enum
{
...
// Define ICE transport policy types
typedef enum
{
...
// Define peer video stream information structure
typedef struct
{
...
// Define peer audio stream information structure
typedef struct
{
...
// Define peer video frame structure
typedef struct
{
...
// Define peer audio frame structure
typedef struct
{
...
// Define peer data frame structure
typedef struct
{
...
// Define data channel reliable type
typedef enum
{
...
// Define data channel configuration structure
typedef struct
{
...
// Define data channel information structure
typedef struct
{
...
// Define peer handle type
typedef void *esp_peer_handle_t;

// Define peer configuration structure
typedef struct
{
...
// Define peer operations structure
typedef struct
{
    /**
...
// RTCPeerModule class definition
class RTCPeerModule
{
private:
    // Event group handle
...
public:
    ...
    // Get the singleton instance of the RTCPeerModule class
    static RTCPeerModule &Instance()
    {
        static RTCPeerModule instance;
        return instance;
    }
    ...
    RTCPeerModule(const RTCPeerModule &) = delete;
    RTCPeerModule &operator=(const RTCPeerModule &) = delete;
