...
#ifndef ES8311_AUDIO_CODEC_H
#define ES8311_AUDIO_CODEC_H
...
// ES8311 Audio Codec class inheriting from AudioCodecBasic
...
public:
    ...
    ES8311AudioCodec(void *i2c_master_handle, i2c_port_t i2c_port, int input_sample_rate_, int output_sample_rate_, gpio_num_t mclk, gpio_num_t bclk, gpio_num_t ws, gpio_num_t dout, gpio_num_t din, gpio_num_t pa_pin_, uint8_t es8311_addr, bool use_mclk_ = true, bool pa_inverted_ = false);
